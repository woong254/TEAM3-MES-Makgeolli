    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: '발주서조회', path: '/purListPage', pro: false },
          { name: '자재조회', path: '/matListPage', pro: false },
        ],
      },
      {
        icon: TableIcon,
        ...
        subItems: [
          ...
          { name: '자재입고검사 조회', path: '/matinsplist', pro: false },
          { name: '자재입고검사 관리', path: '/matinspmanage', pro: false },
          { name: '공정검사 조회', path: '/procinsplist', pro: false },
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: '비가동 설비조회', path: '/downtimelist', pro: false },
          { name: '비가동 설비관리', path: '/downtimeregister', pro: false },
